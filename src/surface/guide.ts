...
function ensureStyle(): void {
  ...
  const css = [
    ...
    '.cdp-surface .gd-orient-p{font-family:Georgia,serif;font-size:14.5px;line-height:1.6;color:var(--text-light,#F0E6CC);}',
    ...
    '.cdp-surface .gd-p{font-family:Georgia,serif;font-size:15px;line-height:1.65;color:var(--text-light,#F0E6CC);margin-bottom:11px;}',
    '.cdp-surface .gd-p:last-child{margin-bottom:0;}',
    '.cdp-surface .gd-row{font-family:Georgia,serif;font-size:14.5px;line-height:1.55;color:var(--text-light,#F0E6CC);margin-bottom:8px;}',
    '.cdp-surface .gd-rlabel{color:var(--gold,#C9A050);font-weight:600;}',
    '.cdp-surface .gd-rdesc{color:var(--text-muted,#D4C8AE);}',
    ...
    '.cdp-surface .gd-vbody{font-family:Georgia,serif;font-size:14px;line-height:1.55;color:var(--text-light,#F0E6CC);}',
