...
function ensureAboutStyle(): void {
  ...
  const css = [
    '.ab-view{position:absolute;inset:0;z-index:60;overflow-y:auto;background:var(--bg,#0A1828);color:var(--text-light,#F0E6CC);font-family:\'EB Garamond\',Georgia,serif}',
