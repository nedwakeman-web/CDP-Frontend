...
(function () {
  ...
  function injectStyle() {
    ...
    var css = [
      '.cdph-handle{position:fixed;top:50%;transform:translateY(-50%);z-index:430;width:27px;height:168px;display:flex;align-items:center;justify-content:center;cursor:pointer;color:' + GOLD + ';background:#122440;border:1px solid ' + GOLD + ';padding:0;font-family:Georgia,serif;transition:color .2s,border-color .2s,background .2s;}',
      '.cdph-handle:hover{color:' + GOLD_SOFT + ';background:#16294a;}',
      '.cdph-handle span{writing-mode:vertical-rl;text-orientation:mixed;font-size:11px;font-weight:600;letter-spacing:2px;text-transform:uppercase;white-space:nowrap;}',
